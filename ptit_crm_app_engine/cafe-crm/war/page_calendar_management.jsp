...
<fmt:setBundle basename="cafe.crm.engine.page_calendar_management" />
...
<head>
<meta charset="utf-8">
<title>Cafe-crm Calendar MAnagement</title>
				...
				<div class="row">
					<div class="span3">
						<ul class="nav nav-list bs-docs-sidenav">
							<li><a href="/cafe_crm.jnlp"><img src="images/import.png" alt="Import"><fmt:message key="download"/> CalendarManager</a> </li>
						</ul>
					</div>
					<div class="span3">
