...
public class ActivitySetting extends PreferenceActivity {
	...
	private void setupSimplePreferencesScreen() {
		...
		try {
			...
			bindPreferenceSummaryToValue(findPreference("mode_debug"));
			Log.i(TAG, "BG list_calendars " + listPreference.getEntries().length);
			List<BgCalendar> listCalendar = this.getApplicationBg().getListCalendars();

			String[] entries = toArrayString(listCalendar) ;
			String[] entriesValues = toArrayStringValue(listCalendar) ;
			listPreference.setEntries(entries);
			listPreference.setEntryValues(entriesValues); 
			//listPreference.setEntryValues(entriesValues);
			//listPreference.setValueIndex(0); 
			bindPreferenceSummaryToValue(findPreference("list_calendars"));
	...
	private String[] toArrayString(List<BgCalendar> listCalendar) {

		List<String> l = new ArrayList<String>();
		l.add("Bdd SQlite ");
		for (BgCalendar bg : listCalendar) {
			l.add(bg.toString());
		}
	...
	private String[] toArrayStringValue(List<BgCalendar> listCalendar) {
	...
	private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener__ = new Preference.OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object value) {
			...
			Log.i(TAG,"AAAAAAAA  Change Setting "+preference+"  "+value);
